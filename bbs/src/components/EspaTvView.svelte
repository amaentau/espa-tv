...
<div class="espatv-view">
  <div class="view-header">
    <h3 class="view-title">Espa TV</h3>
    <p class="view-subtitle">Suorat lähetykset ja tallenteet</p>
  </div>
  
  {#if loading}
    <div class="loading-state">
      <div class="loader"></div>
      <p>Haetaan lähetyksiä...</p>
    </div>
  {:else if error}
    ...
    <div class="stream-grid">
      ...
      {:else}
        <div class="empty-state">
          ...
          <p>Ei suoria lähetyksiä tai tallenteita tällä hetkellä.</p>
        </div>
      {/each}
    </div>
  {/if}
